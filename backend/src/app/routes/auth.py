...
from app.auth.backend_jwt import create_backend_jwt, get_current_user_from_backend_jwt
...
def get_authenticated_user(current_user: User = Depends(get_current_user_from_backend_jwt)):
    ...
    return {
        ...
        "updated_date": current_user.updated_at
    }
...
def sync_user_with_backend(
    ...
    if existing_user_by_email:
        ...
        existing_user_by_email.updated_at = datetime.utcnow()  # Update the timestamp
